...
//연습 문제
text = '현재 접속중인 위부 아이피는 110.8.6.181 이며, 내부아이피는 192.168.0.44 입니다';
//위 text에서 아이피 주소 내부의 숫자들만 골라서 출력하세요.
result = text.match(/\d{1,3}/g);
console.log(result);

//각각의 숫자가 아닌 완벽한 아이피 주소로 매칭해서 출력하세요
...
//아래 문자열중 이름을 제외한 이메일 주소만 추출해서 출력하세요.
text = "park chan ho park@naver.com kim min kyu kim@daum.net Lee dao ho lee@myhome.com a@b.c";
